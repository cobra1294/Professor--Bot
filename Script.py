class script(object):
    START_TXT = """<blockquote>ʜᴇʏ {}, <i>{}</i>
    
ɪ ᴀᴍ ᴘᴏᴡᴇʀғᴜʟ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ ᴡɪᴛʜ ʟɪɴᴋ sʜᴏʀᴛᴇɴᴇʀ ʙᴏᴛ. ʏᴏᴜ ᴄᴀɴ ᴜꜱᴇ ᴀꜱ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ ᴡɪᴛʜ ʟɪɴᴋ sʜᴏʀᴛᴇɴᴇʀ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ... ɪᴛ'ꜱ ᴇᴀꜱʏ ᴛᴏ ᴜꜱᴇ ᴊᴜsᴛ ᴀᴅᴅ ᴍᴇ ᴀꜱ ᴀᴅᴍɪɴ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ɪ ᴡɪʟʟ ᴘʀᴏᴠɪᴅᴇ ᴛʜᴇʀᴇ ᴍᴏᴠɪᴇꜱ ᴡɪᴛʜ ʏᴏᴜʀ ʟɪɴᴋ ꜱʜᴏʀᴛᴇɴᴇʀ... ♻️</blockquote>"""
...
★ Library: <a href=https://pyrogram.org>Pyrogram</a>"""
    ...
    MY_OWNER_TXT = """★ Name: ʀᴏʟᴇx 🦂
★ Username: @meera12_bot
★ Country: ɪɴᴅɪᴀ 🇮🇳"""
...
➥ ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴄʜᴇᴄᴋ ᴡʜɪᴄʜ sʜᴏʀᴛᴇɴᴇʀ ʏᴏᴜ ʜᴀᴠᴇ ᴄᴏɴɴᴇᴄᴛᴇᴅ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴛʜᴇɴ sᴇɴᴅ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴛᴏ ᴛʜᴇ ɢʀᴏᴜᴘ
...
©️ Powered by: <b>{message.chat.title}</b>"""
    ...
    FILE_CAPTION = """<b>📂Fɪʟᴇɴᴀᴍᴇ: </b> @moviez_areas <code>{file_caption}</code>

<b>ᴊᴏɪɴ👇🏻
➠ ➠ <a href='https://t.me/request_your_moviesz'>𝙼𝙾𝚅𝙸𝙴 𝙶𝚁𝙾𝚄𝙿𝟏</a>

➠ ➠ <a href='https://t.me/+cikLkbDz4T01N2Q1'>𝙼𝙾𝚅𝙸𝙴 𝙶𝚁𝙾𝚄𝙿𝟐</a></b>
