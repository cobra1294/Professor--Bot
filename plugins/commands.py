...
async def start(client, message):
    ...
    if not await db.has_premium_access(message.from_user.id):
        if IS_VERIFY and not verify_status['is_verified']:
            ...
            await message.reply("📌<b>ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴠᴇʀɪꜰɪᴇᴅ ᴛᴏᴅᴀʏ 😐ᴛᴀᴘ ᴏɴ ᴛʜᴇ ᴠᴇʀɪꜰʏ ʟɪɴᴋ & ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ғɪʟᴇs ᴛɪʟʟ ɴᴇxᴛ ᴠᴇʀɪꜰɪᴄᴀᴛɪᴏɴ 😊.\n\nइस बॉट को इस्तेमाल करने के लिए आपको रोजाना 2 बार verify करना होगा नहीं तो आप इसका इस्तेमाल नहीं कर पाएंगे.\n\n#ᴠᴇʀɪꜰɪᴄᴀᴛɪᴏɴ:-\n\nɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴅɪʀᴇᴄᴛ ꜰɪʟᴇs ᴛʜᴇɴ ʏᴏᴜ ᴄᴀɴ ᴛᴀᴋᴇ ᴘʀᴇᴍɪᴜᴍ sᴇʀᴠɪᴄᴇ (ɴᴏ ɴᴇᴇᴅ ᴛᴏ ᴠᴇʀɪꜰʏ).\n\nꜰᴏʀ ᴍᴏʀᴇ ᴅᴇᴛᴀɪʟs /plan</b>", reply_markup=InlineKeyboardMarkup(btn), protect_content=True)
            return
    else:
        pass
...
async def save_shortlink(client, message):
    ...
    try:
        ...
        return await message.reply_text("Command")   
    try:
